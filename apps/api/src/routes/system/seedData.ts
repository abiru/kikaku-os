...
export const getStaticPageBody = (slug: string): string | null => {
  const bodies: Record<string, string> = {
    about: [
      '<h2>会社概要</h2>',
      '<p>LED企画は、植物育成用LEDライトを中心に、運用しやすい製品と専門サポートを提供しています。</p>',
      '<h2>サポート方針</h2>',
      '<p>製品選定、設置、運用まで日本語で継続サポートします。問題発生時は迅速に対応します。</p>',
      '<h2>品質と保証</h2>',
      '<p>信頼できるメーカー製品を取り扱い、保証・修理・運用相談まで一貫して支援します。</p>',
      '<h2>情報発信</h2>',
      '<p>SNSや各種コンテンツで最新情報や運用ノウハウを継続的に発信しています。</p>',
    ].join('\n'),
    privacy: [
      '<h2>個人情報保護方針</h2>',
    ...
    legal: [
      ...
      '<p>販売社名: 合同会社SBO</p>',
      '<p>運営統括責任者: 阿比留 真孝</p>',
      '<p>所在地: 〒812-0883 福岡県福岡市博多区南本町2-1-9</p>',
      '<p>メールアドレス: hello@ledkikaku.com</p>',
      '<p>販売URL: https://ledkikaku.com/</p>',
      '<p>商品引渡し時期: ご注文確認後5営業日以内に発送します。</p>',
      '<p>返品・不良品: 不良品・誤配送は到着後7日以内にご連絡ください。</p>',
    ].join('\n'),
    shipping: [
      '<h2>配送ポリシー</h2>',
      '<p>商品は東京または大阪の倉庫から発送されます。発送後に追跡番号をメールでご案内します。</p>',
      '<h2>配送プロセス</h2>',
      '<p>配送状況や天候等により遅延する場合があります。可能な限り迅速に対応いたします。</p>',
      '<h2>リスクと所有権</h2>',
      '<p>商品の受領時点で損失・破損リスクはお客様へ移転します。</p>',
      '<h2>問題発生時</h2>',
      '<p>配送トラブル時はサポート窓口までご連絡ください。</p>',
    ].join('\n'),
    refund: [
      '<h2>返品・返金ポリシー</h2>',
