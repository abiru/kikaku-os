...
import adminProductImages from './routes/adminProductImages';
...
import adminEmailTemplates from './routes/adminEmailTemplates';
import adminAnalytics from './routes/adminAnalytics';
import adminTaxRates from './routes/adminTaxRates';
import adminAds from './routes/adminAds';
