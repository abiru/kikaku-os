		...
		>
			<div className="mx-auto max-w-5xl px-4 pb-4">
				<div className="rounded-2xl bg-white shadow-lg ring-1 ring-gray-200/50 px-6 py-4 flex flex-col sm:flex-row items-start sm:items-center gap-4">
					<p className="text-[13px] text-[#1d1d1f]/80 leading-relaxed flex-1">
						{t('cookie.message')}{' '}
						<a
							href="/privacy"
					...
					<button
						...
						className="shrink-0 rounded-full bg-[#0071e3] px-5 py-2 text-[13px] font-medium text-white transition-colors hover:bg-[#0077ED] active:bg-[#006ADB]"
					>
						{t('cookie.accept')}
					</button>
				</div>
