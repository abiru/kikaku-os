...
type Props = {
  icon?: 'inbox' | 'package' | 'shopping-cart' | 'users' | 'file-text' | 'calendar' | 'tag' | 'truck' | 'mail' | 'clipboard' | 'bar-chart' | 'book' | 'shield'
  message: string
  description?: string
  actionLabel?: string
  actionHref?: string
...
export default function TableEmptyState({ icon = 'inbox', message, description, actionLabel, actionHref }: Props) {
  return (
