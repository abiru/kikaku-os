#!/usr/bin/env python3
"""Remove all dark: Tailwind classes from admin pages."""
...
def main():
    admin_dir = Path('apps/storefront/src/pages/admin')
    files = list(admin_dir.glob('**/*.astro'))

    print(f"Processing {len(files)} admin page files...")
    ...
    for file_path in files:
        ...
        if content != cleaned_content:
            ...
            modified_count += 1
            print(f"✓ {file_path.relative_to('apps/storefront/src/pages/admin')}")
    ...
    if remaining == 0:
        print("\n✓ All dark: classes removed from admin pages!")
    else:
